@if ($books->count() > 0)
   @foreach ($books as $book)
      <li class="search-result__item" data-family="search">
         <a class="search-result__link" href="{{route('dashboard.books.read', $book->id)}}" data-family="search">
            <span class="search-result__title width-40" data-family="search">{{$book->title}}</span>
            <span class="search-result__path width-40" data-family="search">Панель управления/Книги/{{$book->category->title}}</span>
