...
/*!***************************************************!*\
  ...
  \***************************************************/
var companiesPage = document.querySelector('.companies-page');

if (companiesPage) {
  var deleteBtns = companiesPage.querySelectorAll('[data-action="delete"]'),
      ...
      updateInputTitle = updateModal.querySelector('[data-id="title"]'); //* create company start
